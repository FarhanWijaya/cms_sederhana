...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($judul) && !empty($konten)) {
        ...
        $gambar = $artikel['gambar']; // Gunakan gambar yang ada
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="artikel_edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <select class="form-control" id="kategori_id" name="kategori_id">
                      ...
                      <?php while ($kategori = mysqli_fetch_assoc($kategori_result)): ?>
                        <option value="<?php echo $kategori['id']; ?>" 
                                <?php echo $kategori['id'] == $artikel['kategori_id'] ? 'selected' : ''; ?>>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="konten" name="konten" required>
                      <?php echo htmlspecialchars($artikel['konten']); ?>
                    </textarea>
                  </div>
